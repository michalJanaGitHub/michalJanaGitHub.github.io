...
app.getSettingsFromLocalStorage = function () {
  ...
  if (app.delayBtwSounds === null) app.delayBtwSounds = 0;

  if (app.delayBtwTriples === null) app.delayBtwTriples = 750;
  if (app.delayBtwChars === null) app.delayBtwChars = 1250;
  if (app.delayBtwWords === null) app.delayBtwWords = 2000;
  if (app.translationTableZoom === null) app.translationTableZoom = 0.2;
};
